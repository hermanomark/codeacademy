...
// The diagram to the right shows the relationships we want to create between the Animal, Cat, and Dog classes. (saved in the same folder)
...
//Extra practice, add a Doctor class
class HospitalEmployee {
  constructor(name) {
    this._name = name;
    this._remainingVacationDays = 20;
...
const joey = new Doctor("Joey", ['Health Insurance', 'Life Insurance'] );
joey.takeVacationDays(7);
console.log(joey.remainingVacationDays);
console.log(joey.insurance);
